...
include "co.mm"
include "cfv.mm"
include "cdlemeg46fsfv.mm"
include "oveq1d.mm"
include "cdlemeg46frv.mm"
include "eqtrd.mm"
include "syl5eq.mm"

theorem cdlemeg46v1v2
  let vx: setvar x
  let vy: setvar y
  let vz: setvar z
  let vv: setvar v
  ...
  disjoint c s
  disjoint c t
  assert |- ( ( ( ( K e. HL /\ W e. H ) /\ ( P e. A /\ -. P .<_ W ) /\ ( Q e. A /\ -. Q .<_ W ) ) /\ ( P =/= Q /\ ( R e. A /\ -. R .<_ W ) /\ ( S e. A /\ -. S .<_ W ) ) /\ ( R .<_ ( P .\/ Q ) /\ -. S .<_ ( P .\/ Q ) ) ) -> X = Y )
