...
include "cfv.mm"
include "eqid.mm"
include "cdlemeg46gfv.mm"
include "cdlemeg46req.mm"
include "eqtr4d.mm"

theorem cdlemeg46gfr
  let vx: setvar x
  let vy: setvar y
  let vz: setvar z
  let vv: setvar v
  ...
  disjoint c s
  disjoint c t
  assert |- ( ( ( ( K e. HL /\ W e. H ) /\ ( P e. A /\ -. P .<_ W ) /\ ( Q e. A /\ -. Q .<_ W ) ) /\ ( P =/= Q /\ ( R e. A /\ -. R .<_ W ) /\ ( S e. A /\ -. S .<_ W ) ) /\ ( R .<_ ( P .\/ Q ) /\ -. S .<_ ( P .\/ Q ) ) ) -> ( G ` ( F ` R ) ) = R )
