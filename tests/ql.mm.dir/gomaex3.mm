...
theorem gomaex3(wva: $term$ a, wvb: $term$ b, wvc: $term$ c, wvd: $term$ d, wve: $term$ e, wvf: $term$ f, wvg: $term$ g, wvk: $term$ k, wvi: $term$ i, wvn: $term$ n, wvp: $term$ p, wvq: $term$ q, wvr: $term$ r, wvw: $term$ w, wvy: $term$ y) {
